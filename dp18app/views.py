...
def home(request):
    return render(request,"dp18app/home.html")



def profile(request):
    name="akshay"
    return render(request,"dp18app/profile.html",{'name':name})
...
def register(request):
    ...
    return render(request,"dp18app/register.html")
...
from django.core.files.storage import FileSystemStorage
from dp18app.utilities import store_image
